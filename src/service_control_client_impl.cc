...
void ServiceControlClientImpl::Check(
  ...
  if (status.error_code() == Code::NOT_FOUND) {
    // TODO(qiwzhang): not to make a copy here.
    CheckRequest* check_request_copy = new CheckRequest(check_request);
    non_blocking_transport_->Check(*check_request_copy, check_response, [
      check_aggregator_copy = check_aggregator_, check_request_copy,
...
::google::protobuf::util::Status ServiceControlClientImpl::Blocking_Check(
    const ::google::api::servicecontrol::v1::CheckRequest& check_request,
    ::google::api::servicecontrol::v1::CheckResponse* check_response) {
...
::google::protobuf::util::Status ServiceControlClientImpl::Blocking_Report(
    const ::google::api::servicecontrol::v1::ReportRequest& report_request,
    ::google::api::servicecontrol::v1::ReportResponse* report_response) {
  return Status(Code::UNIMPLEMENTED, "This method is not implemented yet.");
}
...
std::unique_ptr<ServiceControlClient> CreateServiceControlClient(
  ...
  return std::unique_ptr<ServiceControlClient>(new ServiceControlClientImpl(
      service_name, check_options, report_options, metric_kind));
}
