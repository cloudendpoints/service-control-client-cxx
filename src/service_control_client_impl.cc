...
void ServiceControlClientImpl::Check(TransportCheckFunc check_transport,
                                     const CheckRequest& check_request,
...
void ServiceControlClientImpl::Check(const CheckRequest& check_request,
                                     CheckResponse* check_response,
                                     DoneCallback on_check_done) {
  Check(check_transport_, check_request, check_response, on_check_done);
}
...
void ServiceControlClientImpl::Report(TransportReportFunc report_transport,
                                      const ReportRequest& report_request,
...
void ServiceControlClientImpl::Report(const ReportRequest& report_request,
                                      ReportResponse* report_response,
                                      DoneCallback on_report_done) {
  Report(report_transport_, report_request, report_response, on_report_done);
}
