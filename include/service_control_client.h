...
struct ServiceControlClientOptions {
  ...
  // CreateGrpcTransport() defined in plugtable_interfaces.h
  ...
  // If false, the library will create a separate thread to call Flush()
  // with desired flush interval.
  // Default, call_flush_manually is false.
  bool call_flush_manually;
};
...
//    }
//
// 2) Most popular way; uses custom transport, calls
